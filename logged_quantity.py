...
import json
import sys
from helper_funcs import get_logger_from_class, str2bool, QLock
from ndarray_interactive import ArrayLQ_QTableModel
    ...
    def connect_to_widget(self, widget):
        ...
        **Arguments**  **Description**
        ...
        if type(widget) == QtWidgets.QDoubleSpinBox:
            ...
            widget.close_video() # removes all old choices
